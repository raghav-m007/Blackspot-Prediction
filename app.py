...
model = joblib.load(r'Model/myjoblib1.joblib')
...
def main():
    with st.form('prediction_form'):
       ...
       no_of_lane = st.slider("No of Lane: ", 0, 2, value=0, format="%d")
    ...
    if submit:
       ...
       print(fatalities, greviously_injured, minor_injured, no_of_lane, surface_condition, physical_driver, road_under_work_construction, load_condition)
       ...
       data = np.array([fatalities, greviously_injured, minor_injured, no_of_lane, surface_condition, physical_driver, road_under_work_construction, load_condition])
       print(fatalities, greviously_injured, minor_injured, no_of_lane, surface_condition, physical_driver, road_under_work_construction, load_condition)
